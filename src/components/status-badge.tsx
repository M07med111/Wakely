...
const map: Record<Variant, { cls: string; label: string }> = {
  ...
  urgent:  { cls: "bg-rose-500/20 text-rose-200 border-rose-500/40 animate-pulse", label: "جلسة قريبة" },
};
...
export function StatusBadge({
  ...
  return (
    <span className={`inline-flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded-full border ${m.cls}`}>
