    ...
    <>
      ...
      {!editing ? (
        ...
        <button
          ...
          className="inline-flex items-center gap-1 text-xs px-2.5 py-1.5 rounded-md border border-rose-500/40 text-rose-400 hover:bg-rose-500/10"
          title="حذف الموكل"
        >
        ...
        <Tabs defaultValue="info" className="w-full">
          ...
          <TabsContent value="info" className="mt-4">
            ...
            {client.poa_file_path && (
              <div className="mt-4 flex items-center justify-between gap-3 rounded-md border border-border bg-card/50 p-3">
                <div className="text-sm">
                  <div className="font-semibold">ملف التوكيل مرفق</div>
                ...
                {cases
                  ...
                  .map((c: any) => (
                    ...
                    >
                      ...
                      {c.next_session_date && (
                        <div className="text-[11px] text-[var(--gold)] mt-1">
                          جلسة: {format(new Date(c.next_session_date), "yyyy/MM/dd")}
                        </div>
                      )}
                    </Link>
                  ))}
      ...
      <div className="fixed inset-0 z-[70] grid place-items-center bg-black/70 backdrop-blur-sm p-4">
        <div className="glass-card w-full max-w-md p-6 border-rose-500/40">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            سيتم حذف <strong className="text-foreground">{client?.full_name}</strong> نهائيا،
